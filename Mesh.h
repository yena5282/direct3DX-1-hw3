/*
* 정점 ~ 메쉬까지의 집합체 생성과정,
* 메쉬의 투영 사각형 내외부 존재 판단 
* 현재 코드에서 띄우고자 하는 메쉬 와인딩과정(CCubeMesh) 
* 
*/
#pragma once
...
{
public:
	CAirplaneMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth=20.0f, float fHeight = 4.0f, float fDepth = 20.0f,
		XMFLOAT4 xmf4Color = XMFLOAT4(1.0f, 0.5f, 0.8f, 0.0f));
