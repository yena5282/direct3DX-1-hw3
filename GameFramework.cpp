...
{
	_tcscpy_s(m_pszFrameRate, _T("LabProjects("));
	m_pdxgiFactory = NULL;
	...
	for (int i = 0; i < m_nSwapChainBuffers; i++) m_ppd3dRenderTargetBuffers[i] = 0;
	m_pScene = NULL;
...
void CGameFramework::CreateDirect3DDevice()
{
	...
	if (!pd3dAdapter)
	{
		m_pdxgiFactory->EnumWarpAdapter(_uuidof(IDXGIAdapter), (void**)&pd3dAdapter);
...
void CGameFramework::CreateCommandQueueAndList()
{
	...
	hResult = m_pd3dDevice->CreateCommandList(1, D3D12_COMMAND_LIST_TYPE_DIRECT,m_pd3dCommandAllocator, NULL,__uuidof(ID3D12GraphicsCommandList), (void**)&m_pd3dCommandList);
